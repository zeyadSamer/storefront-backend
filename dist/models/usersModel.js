...
var storeUser = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        sql = "insert into users(id,firstname,lastname,userpassword) values($1,$2,$3,$4) returning *";
                        hashedPassword = bcrypt_1["default"].hashSync(u.password + pepper, parseInt(saltRounds));
                        return [4 /*yield*/, connection.query(sql, [u.id, u.firstName, u.lastName, hashedPassword])];
                    case 2:
                        result = _a.sent();
                        connection.release();
                        return [2 /*return*/, result.rows[0]];
    ...
    storeUser.prototype.authenticateUser = function (firstname, lastname, password) {
        return __awaiter(this, void 0, void 0, function () {
